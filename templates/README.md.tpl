...
[%{{first_video_title}}%](https://www.youtube.com/watch?v=%{{first_video_id}}%)

[![Latest YouTube Video](http://img.youtube.com/vi/%{{first_video_id}}%/mqdefault.jpg)](https://www.youtube.com/watch?v=%{{first_video_id}}%)

[![YouTube Video Views](https://img.shields.io/youtube/views/%{{first_video_id}}%?color=FF0000&label=Views&style=for-the-badge)](https://www.youtube.com/watch?v=%{{first_video_id}}%)
[![YouTube Video Likes](https://img.shields.io/youtube/likes/%{{first_video_id}}%?color=FF0000&label=Likes&style=for-the-badge)](https://www.youtube.com/watch?v=%{{first_video_id}}%)
